...
# Use a uniform distribution to simulate proportion grass coverage
...
# Take a look at your mean values.  If they look wonky,
# try different values for the slope and intercept.
...
# Please try some values based on the figure on the Wiki page.
...
observers = matrix(rbinom(n = n*nobs, size = foxdens$dens, prob = dprob), ncol = 3)
...
# the fitting process.  Try using ?pcount in the console
...
# Plot to compare to your simulated values of abundance to
# the estimated values of abundance
